...
### [1] [The Birth of Radar Meteor Astronomy at Jodrell Bank: The Collaboration between Bernard Lovell and Manning Prentice](https://arxiv.org/abs/2608.18790)
*Jeremy Shears*
...
### [2] [Could John Ellard Gore have pre-empted the Hertzsprung-Russell diagram?](https://arxiv.org/abs/2608.18799)
*Jeremy Shears*
...
### [3] [Hidden Variables in Quantum Mechanics: A Journey Into de Broglie-Bohm Pilot-Wave Theory](https://arxiv.org/abs/2608.18829)
*Andrea Oldofredi*
...
### [4] [Stefan Bergman (1895-1977). Notes on His Bio- and Bibliography](https://arxiv.org/abs/2608.18927)
*Tilman Sauer*
...
### [5] [Qkabrine: A Joint Architecture, Encoding, and Hyperparameter Search Framework for Quantum Machine Learning](https://arxiv.org/abs/2608.18152)
*Eric Jagwara*
...
### [6] [Quantum Processes under Epistemic Constraints](https://arxiv.org/abs/2608.18159)
*Varun Immanuel*
...
### [8] [Branching (Almost) Everywhere And All at Once](https://arxiv.org/abs/2608.18644)
*Alyssa Ney*
...
### [9] [How Quantum Is the Advantage? A Fair, Calibration- and Noise-Aware Benchmark and Attribution Audit of Quantum Machine Learning for Network Intrusion Detection](https://arxiv.org/abs/2608.18155)
...
### [10] [Observable Scaling Hierarchies in Multiphoton Dissipative Quantum Sensing](https://arxiv.org/abs/2608.18157)
*Shahram Panahiyan*
...
### [11] [Symmetric $N \to M$ telecloning and remote quantum state inference](https://arxiv.org/abs/2608.18223)
...
### [12] [Pseudocontexts forced by finite context hypergraphs](https://arxiv.org/abs/2608.18273)
...
### [13] [Generalizing Pauli Checks for Qudit-based Quantum Error Detection and Mitigation](https://arxiv.org/abs/2608.18332)
...
### [14] [Quantum-geometric bounds on Casimir repulsion](https://arxiv.org/abs/2608.18347)
*Adolfo G. Grushin*
...
### [15] [Variational Quantum Algorithms for Hyperelasticity: Incorporating Nonlinear Constitutive Behavior](https://arxiv.org/abs/2608.18363)
...
### [16] [Entropic Rigidity in Quantum Memories: How Geometry and Algebra Control the Onset of Degeneracy Corrections](https://arxiv.org/abs/2608.18420)
*Yixin Zhao,Fei Yan*
...
### [17] [Multiqubit orthogonal product bases](https://arxiv.org/abs/2608.18421)
*Yvkai Zhao,Lin Chen*
...
### [18] [Asymptotic Entanglement Hiding under Stabilizer Restrictions](https://arxiv.org/abs/2608.18440)
...
### [19] [Multicast quantum network coding as optimal symmetric universal cloning over a quantum network](https://arxiv.org/abs/2608.18471)
...
### [20] [Unified Strong-Field Dynamics Simulations from Atoms to Heterostructures](https://arxiv.org/abs/2608.18472)
...
### [21] [Sampling isometric tensor network states with monitored quantum circuits](https://arxiv.org/abs/2608.18511)
...
### [22] [Integer Linear Programming Decoder for Abelian and Non-Abelian Topological Codes](https://arxiv.org/abs/2608.18512)
...
### [23] [Good Stabilizer Codes from Shallow Clifford Circuits with Random Matchings](https://arxiv.org/abs/2608.18536)
...
### [24] [Direct fidelity estimation through joint fiducial grouping](https://arxiv.org/abs/2608.18548)
...
### [25] [Know Your Qubits, Know Your Users: Personas for Quantum Software](https://arxiv.org/abs/2608.18598)
...
### [26] [Inverse Feshbach's problem: Solvability and solutions](https://arxiv.org/abs/2608.18600)
*Miloslav Znojil*
...
### [27] [Exact Matching-Polynomial Solution of the Periodic Baxter-Fendley $Z_N$ Clock Chain](https://arxiv.org/abs/2608.18633)
...
### [28] [(Almost) quadruply optimal unitary designs in 1D](https://arxiv.org/abs/2608.18650)
...
### [29] [Quantum-Logic Tsetlin Machines: Interpretable Quantum Machine Learning with Commuting Projector Clauses](https://arxiv.org/abs/2608.18659)
*Krishna Bhatia*
...
### [30] [Experimental zero-added-loss multiplexing Bell-pair source for long-haul quantum networks](https://arxiv.org/abs/2608.18666)
...
### [31] [An ultracompact dilution refrigerator for fast quantum device characterization](https://arxiv.org/abs/2608.18699)
...
### [32] [Robustness of spin state superpositions for noisy quantum metrology](https://arxiv.org/abs/2608.18757)
...
### [33] [Interior skin focusing and directional mirror transfer in a graded non-Hermitian Krawtchouk network](https://arxiv.org/abs/2608.18800)
*Y. S. Liu,X. Z. Zhang*
...
### [34] [Quantum Mixedness Testing with Pauli Measurements](https://arxiv.org/abs/2608.18839)
...
### [35] [Copy-Protection with Correlated Challenges: Point Functions and More via Decisional Coset Monogamy](https://arxiv.org/abs/2608.18841)
...
### [36] [Secure Medical Data Transmission Using Quantum Key Distribution and Post-Quantum Cryptography in Real-World Fiber Networks](https://arxiv.org/abs/2608.18869)
...
### [37] [The exact price of local realism in CHSH experiments: a measurement-dependence-detection trade-off surface, a moiré phase-locking mechanism that saturates it, and an unmeasured fringe in the fourfold coincidence sum](https://arxiv.org/abs/2608.18886)
*Aaron Alai*
...
### [38] [Quantum Tensor Network Learning with DMRG](https://arxiv.org/abs/2608.18901)
...
### [39] [Real Classical Shadows with Noise](https://arxiv.org/abs/2608.18935)
...
### [40] [Quantum-Enhanced Atomic Sensor via Spin Nonequilibrium Criticality](https://arxiv.org/abs/2608.18941)
...
### [41] [AlphaClifford: Efficient Clifford Synthesis and Transpilation with Model-based RL](https://arxiv.org/abs/2608.18946)
...
### [42] [An ultra-bright, highly-scalable, squeezed light source for hybrid quantum photonics](https://arxiv.org/abs/2608.18950)
...
### [43] [Subsystem Symmetries and Fracton Models in Quantum Error Correction](https://arxiv.org/abs/2608.18961)
*Giovanni Canossa*
...
### [44] [Deviation from linear reduced dynamics always occurs for each non-factorisable system-environment unitary evolution](https://arxiv.org/abs/2608.18977)
*Iman Sargolzahi*
...
### [45] [RushHour: A Dynamically Reconfigurable Lattice-Surgery Architecture](https://arxiv.org/abs/2608.18985)
...
### [46] [Interface Capacity and Architectural Replenishment Determine Entanglement-Generation Speed in Quantum Networks](https://arxiv.org/abs/2608.19020)
*Shi-Ju Ran*
...
### [47] [Bernstein-Vazirani Networks: Quantum Machine Learning by Interference](https://arxiv.org/abs/2608.19043)
...
### [48] [Distinct Modes of Quantum Information Transfer in Power-Law Long-Range Spin Networks](https://arxiv.org/abs/2608.19057)
...
### [49] [Non-Local Search-to-Decision Reduction over F2](https://arxiv.org/abs/2608.19091)
*Prabhanjan Ananth*
...
### [50] [Realizing Logical Diagonal Gates via Transversal Physical $Z$-Rotations in CSS Codes](https://arxiv.org/abs/2608.19094)
...
### [51] [Quantum circuit optimization using deep reinforcement learning: Applications across multiple gate sets](https://arxiv.org/abs/2608.19103)
...
### [52] [Connectivity--Interference Competition in Coherent Transport on Percolated Hierarchical Small-World Networks](https://arxiv.org/abs/2608.19130)
...
### [53] [Entanglement battery and entanglement catalyst in local state discrimination problems](https://arxiv.org/abs/2608.19139)
...
### [54] [Quantum Speedups Require Structure or Depth](https://arxiv.org/abs/2608.19158)
...
### [55] [State--Generator Geometry of Open Quantum Systems: Compatibility and Covariant Transport](https://arxiv.org/abs/2608.19175)
