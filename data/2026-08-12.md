...
### [1] [Was Schrödinger ever a determinist?](https://arxiv.org/abs/2608.10160)
...
### [5] [The Thermodynamic Cost of Computing with Heat](https://arxiv.org/abs/2608.10027)
*M. W. AlMasri*
...
### [6] [Catalytic Stabilization of Ergotropy and Backflow Suppression in Open Many-Body Quantum Batteries](https://arxiv.org/abs/2608.10032)
...
### [8] [ND-Photonic QRNGs in a Noisy Environment](https://arxiv.org/abs/2608.10053)
...
### [10] [Phase diagram of lasing under correlated pump from GPU-accelerated Truncated Wigner dynamics](https://arxiv.org/abs/2608.10075)
...
### [11] [Eliminating photon transport in long-baseline optical interferometry using quantum memories](https://arxiv.org/abs/2608.10078)
...
### [12] [Kinetics of sliding-window quantum error correction](https://arxiv.org/abs/2608.10081)
...
### [13] [Long-lived memory effects in the defect bath of superconducting qubits](https://arxiv.org/abs/2608.10087)
...
### [14] [Non-equilibrium theory of projected ensembles](https://arxiv.org/abs/2608.10110)
...
### [15] [Bounds for Apparent Second-Law Violations in Quantum Trajectories](https://arxiv.org/abs/2608.10118)
...
### [16] [Williamson majorization theory of fermionic non-Gaussianity](https://arxiv.org/abs/2608.10140)
...
### [17] [Unextendible stabiliser bases](https://arxiv.org/abs/2608.10202)
*Markus Frembs*
...
### [18] [Bayesian approach to simultaneous quantum multiparameter estimation with finite data](https://arxiv.org/abs/2608.10230)
...
### [19] [Programmable Heisenberg-limit sensor from a nonlinear quantum energy pump](https://arxiv.org/abs/2608.10308)
*Yang Peng*
...
### [20] [Wave-particle-mixedness redistribution in Schwarzschild spacetime](https://arxiv.org/abs/2608.10334)
...
### [21] [Symmetrized Block-Product Periodic Marginals in Infinite Translation-Invariant Quantum Chains](https://arxiv.org/abs/2608.10365)
...
### [22] [Private Correlations Certify Sensing Capability](https://arxiv.org/abs/2608.10377)
...
### [23] [A Single Atom in Front of a Mirror is a Universal Reservoir Computer](https://arxiv.org/abs/2608.10382)
...
### [24] [Simultaneous Heisenberg-Limited Multiparameter Metrology via Indefinite Evolution](https://arxiv.org/abs/2608.10490)
...
### [25] [State-Dependent Visibility of Non-Commutative Ordering in Quantum Dynamics](https://arxiv.org/abs/2608.10540)
...
### [26] [Unified Exact Cylindrical Dirac Modes and Symmetry-Resolved Quantum Geometry](https://arxiv.org/abs/2608.10563)
...
### [27] [Stream Decoding with Confidence Scores at Room and Cryogenic Temperatures](https://arxiv.org/abs/2608.10576)
...
### [28] [Generating GKP states using quantum dots inside a strongly coupled cavity](https://arxiv.org/abs/2608.10604)
...
### [29] [Nanoscale graphitization and defect evolution in silicon-vacancy center-containing nanodiamonds under high-pressure high-temperature annealing](https://arxiv.org/abs/2608.10632)
...
### [30] [Zero transfer on mixed graphs](https://arxiv.org/abs/2608.10643)
...
### [31] [Photonic realization of a subgraph extraction in a quantum random network](https://arxiv.org/abs/2608.10663)
...
### [32] [Quantum Computing for Industrial Electromagnetics: Applicability and Case Studies in Solving Maxwell's Equations](https://arxiv.org/abs/2608.10671)
...
### [33] [Optimal fidelity estimation when one state is pure via algorithmic Uhlmann transform](https://arxiv.org/abs/2608.10674)
...
### [34] [Helium-like ions $(Z,e,e)$ in Lagrange Mesh method, interpolating the highly-accurate energy spectra vs. Z](https://arxiv.org/abs/2608.10695)
...
### [35] [Quantum steering is equivalent to state-preserving conditional expectations](https://arxiv.org/abs/2608.10783)
...
### [36] [Resource-bounded controllability benchmarking of open quantum systems](https://arxiv.org/abs/2608.10789)
...
### [37] [A Quantum Algorithm for Solving the Poisson Equation for Free Field Conditions via the Hockney Method](https://arxiv.org/abs/2608.10809)
...
### [38] [Projection measurement of the comb basis through free-electron-photon interactions](https://arxiv.org/abs/2608.10831)
...
### [39] [Theoretical analysis towards accurate optomechanical detection of quantum gravity effects](https://arxiv.org/abs/2608.10890)
...
### [40] [Boosting self hybridized exciton polaritons with metal clad WS2 waveguides](https://arxiv.org/abs/2608.10895)
...
### [41] [A Quantum Dynamics Tutorial: Visualising Dynamical Decoupling Sequences on the Bloch Sphere](https://arxiv.org/abs/2608.10914)
...
### [42] [Quantum Signatures of Two-Electron HBT Interference in Free Space](https://arxiv.org/abs/2608.10917)
...
### [43] [Enhanced two-photon blockade without cascade channel by Stark nonlinear coupling](https://arxiv.org/abs/2608.10942)
...
### [44] [Verifying full quantum network nonlocality in arbitrary configurations by nonlinear Bell-like inequalities](https://arxiv.org/abs/2608.10972)
...
### [45] [The entanglement-assisted transmission capacity is a strong converse bound for identification](https://arxiv.org/abs/2608.11000)
*Satvik Singh*
...
### [46] [Entanglement depth and ancilla efficiency in quantum channel estimation](https://arxiv.org/abs/2608.11042)
*Javid Naikoo*
...
### [47] [Quantum Coordination Advantages in AI State-Tracking Tasks: Semantic Compilation and Latent Memory](https://arxiv.org/abs/2608.11066)
*Ming Yang*
...
### [48] [Physics-Constrained Compressed Sensing for Quantum Sensing in the Data-Starved Regime](https://arxiv.org/abs/2608.11092)
*Amir Kalev*
...
### [49] [Robust CHSH Self-Testing with Finite-Energy GKP States](https://arxiv.org/abs/2608.11122)
...
### [50] [A Sharp Local-Question Threshold for GHZ-Equatorial Completeness in Four-Player XOR Games](https://arxiv.org/abs/2608.11139)
...
### [51] [Breaking the Quadratic Barrier for von Neumann Entropy Estimation](https://arxiv.org/abs/2608.11151)
...
### [52] [Quantum Codes with Arbitrary Z-Rotation logical Gates and Applications to Fault-Tolerant Code Switching](https://arxiv.org/abs/2608.11160)
...
### [53] [Impact of strain and dark states on spectroscopic measurements of silicon-vacancy centers in diamond](https://arxiv.org/abs/2608.11168)
...
### [54] [A Quantum Roadmap for Softmax Attention: Exact Born-Rule Analogs for Softmax Attention on the Probability Simplex](https://arxiv.org/abs/2608.11173)
...
### [55] [Statistically-Secure Bit Commitment and Coin Flipping Protocols Based on Quantum Hardware Assumptions](https://arxiv.org/abs/2608.11187)
...
### [56] [Work distribution for strongly coupled many-body open quantum systems](https://arxiv.org/abs/2608.11196)
