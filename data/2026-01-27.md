...
### [8] [Quantum Phase Transitions in the Transverse-Field Ising Model: A Comparative Study of Exact, Variational, and Hardware-Based Approaches](https://arxiv.org/abs/2601.17515)
*Rudraksh Sharma*
...
### [9] [Autonomous phonon maser in levitated spin-mechanics](https://arxiv.org/abs/2601.17552)
*Mohamed Hatifi*
...
### [10] [Holstein Primakoff spin codes for local and collective noise](https://arxiv.org/abs/2601.17592)
...
### [11] [Generalized Aharonov-Bohm Effect](https://arxiv.org/abs/2601.17659)
*Shan Gao*
...
### [12] [From Joint to Single-System Psi-Onticity Without Preparation Independence](https://arxiv.org/abs/2601.17662)
*Shan Gao*
...
### [13] [Comment on "Aharonov-Bohm Phase is Locally Generated Like All Other Quantum Phases"](https://arxiv.org/abs/2601.17665)
*Shan Gao*
...
### [14] [Realisation of Protected Cat Qutrit via Engineered Quantum Tunnelling](https://arxiv.org/abs/2601.17675)
...
### [15] [Exponential Quantum Speedup on Structured Hard Instances of Maximum Independent Set](https://arxiv.org/abs/2601.17686)
*Vicky Choi*
...
### [16] [Traversability dynamics of minimal Sachdev-Ye-Kitaev Wormhole-inspired teleportation protocol with a parity-time ($\mathcal{PT}$)-symmetric non-Hermitian deformation](https://arxiv.org/abs/2601.17688)
...
### [17] [Quantum-Inspired Algorithms beyond Unitary Circuits: the Laplace Transform](https://arxiv.org/abs/2601.17724)
...
### [18] [Reducing Circuit Resources in Grover's Algorithm via Constraint-Aware Initialization](https://arxiv.org/abs/2601.17725)
...
### [19] [Quantum fast-forwarding fermion-boson interactions via the polaron transform](https://arxiv.org/abs/2601.17732)
...
### [20] [Simple, Efficient, and Generic Post-Selection Decoding for qLDPC codes](https://arxiv.org/abs/2601.17757)
...
### [21] [Kirkwood-Dirac Quasiprobability as a Universal Framework for Quantum Measurements Across All Regimes](https://arxiv.org/abs/2601.17788)
...
### [22] [Bosonic Diffusive Channel: Quantum Metrology via Finite Non-Gaussian Resource](https://arxiv.org/abs/2601.17804)
...
### [23] [Experimental Phase-Matching Quantum Cryptographic Conferencing in Symmetric and Asymmetric Fiber Channels](https://arxiv.org/abs/2601.17819)
...
### [24] [Multivariate Rényi divergences characterise betting games with multiple lotteries](https://arxiv.org/abs/2601.17850)
...
### [25] [On Tunneling in the Quantum Multiverse](https://arxiv.org/abs/2601.17856)
*S. E. Ennadifi*
...
### [26] [Quantum Machine Learning Using Quantum Illumination With Quantum Enhanced Interference](https://arxiv.org/abs/2601.17870)
...
### [27] [Coherent Amplifier-Empowered Quantum Interferometer: Preserving Sensitivity and Quantum Advantage under High Loss](https://arxiv.org/abs/2601.17876)
...
### [28] [Colour Centre Formation in Silicon-On-Insulator for On-Chip Photonic Integration](https://arxiv.org/abs/2601.17919)
...
### [29] [Perturbation Theory and the Quantum Rabi-model](https://arxiv.org/abs/2601.17924)
...
### [30] [The hyperlink representation of entanglement and the inclusion-exclusion principle](https://arxiv.org/abs/2601.17926)
...
### [31] [A Rigorous and Self--Contained Proof of the Grover--Rudolph State Preparation Algorithm](https://arxiv.org/abs/2601.17930)
...
### [32] [Elementary Quantum Gates from Lie Group Embeddings in $U(2^n)$: Geometry, Universality, and Discretization](https://arxiv.org/abs/2601.17936)
*Antonio Falco,Daniela Falco-Pomares,Hermann G. Matthies*
...
### [33] [Quantum Radar System Using Born-Feynman path integrals approach](https://arxiv.org/abs/2601.17956)
...
### [34] [Authentication in Security Proofs for Quantum Key Distribution](https://arxiv.org/abs/2601.17960)
...
### [35] [Quantum Paradoxes and the Quantum-Classical Transition under Unitary Measurement Dynamics with Random Hamiltonians](https://arxiv.org/abs/2601.17976)
*Alexey A. Kryukov*
...
### [36] [Linear combination of unitaries with exponential convergence](https://arxiv.org/abs/2601.18024)
...
### [37] [A rigorous and complete security proof of decoy-state BB84 quantum key distribution](https://arxiv.org/abs/2601.18035)
...
### [38] [Overcoming Barren Plateaus in Variational Quantum Circuits using a Two-Step Least Squares Approach](https://arxiv.org/abs/2601.18060)
...
### [39] [Feedback-Based Quantum Control for Safe and Synergistic Drug Combination Design](https://arxiv.org/abs/2601.18082)
...
### [40] [Two-Polariton Blockade via Ultrastrong Light-Matter Coupling](https://arxiv.org/abs/2601.18083)
...
### [41] [Sparse QUBO Formulation for Efficient Embedding via Network-Based Decomposition of Equality and Inequality Constraints](https://arxiv.org/abs/2601.18108)
...
### [42] [Quantum Recurrent Unit: A Parameter-Efficient Quantum Neural Network Component](https://arxiv.org/abs/2601.18164)
...
### [43] [Resource-Efficient Noise Spectroscopy for Generic Quantum Dephasing Environments](https://arxiv.org/abs/2601.18290)
...
### [44] [Scalable Repeater Architecture for Long-Range Quantum Energy Teleportation in Gapped Systems](https://arxiv.org/abs/2601.18327)
...
### [45] [Scaling of multicopy constructive interference of Gaussian states](https://arxiv.org/abs/2601.18347)
...
### [46] [An Adaptive Purification Controller for Quantum Networks: Dynamic Protocol Selection and Multipartite Distillation](https://arxiv.org/abs/2601.18351)
...
### [47] [Bohr's complementarity principle tested on a real quantum computer via interferometer experiments](https://arxiv.org/abs/2601.18366)
...
### [48] [Atom-light hybrid interferometer for atomic sensing with quantum memory](https://arxiv.org/abs/2601.18373)
...
### [49] [Quantum Error Correction on Error-mitigated Physical Qubits](https://arxiv.org/abs/2601.18384)
...
### [50] [Emergent Cooperation in Quantum Multi-Agent Reinforcement Learning Using Communication](https://arxiv.org/abs/2601.18419)
...
### [51] [A Theory of Single-Antenna Atomic Beamforming](https://arxiv.org/abs/2601.18426)
...
### [52] [Physics-Informed Hybrid Quantum-Classical Dispatching for Large-Scale Renewable Power Systems:A Noise-Resilient Framework](https://arxiv.org/abs/2601.18482)
...
### [53] [Qubit-parity interference despite unknown interaction phases](https://arxiv.org/abs/2601.18499)
...
### [54] [Imperfect blockade in Rydberg superatoms](https://arxiv.org/abs/2601.18506)
...
### [55] [Simultaneous determination of multiple low-lying energy levels on a superconducting quantum processor](https://arxiv.org/abs/2601.18514)
...
### [56] [Quantum Key Distribution with a Negatively Charged Quantum Dot Single-Photon Source](https://arxiv.org/abs/2601.18518)
*Parvendra Kumar*
...
### [57] [Certifying optimal device-independent quantum randomness in quantum networks](https://arxiv.org/abs/2601.18534)
...
### [58] [Sufficient conditions for additivity of the zero-error classical capacity of quantum channels](https://arxiv.org/abs/2601.18538)
...
### [59] [Bayesian Optimization for Quantum Error-Correcting Code Discovery](https://arxiv.org/abs/2601.18562)
...
### [60] [Universality of Many-body Projected Ensemble for Learning Quantum Data Distribution](https://arxiv.org/abs/2601.18637)
...
### [61] [Error-mitigation aware benchmarking strategy for quantum optimization problems](https://arxiv.org/abs/2601.18680)
...
### [62] [Data-Driven Qubit Characterization and Optimal Control using Deep Learning](https://arxiv.org/abs/2601.18704)
...
### [63] [Nontrivial bounds on extractable energy in quantum energy teleportation for gapped manybody systems with a unique ground state](https://arxiv.org/abs/2601.18718)
*Taisanul Haque*
...
### [64] [On the Stochastic-Quantum Correspondence](https://arxiv.org/abs/2601.18720)
*Sami Calvo*
...
### [65] [Approximate level-by-level maximum-likelihood decoding based on the Chase algorithm for high-rate concatenated stabilizer codes](https://arxiv.org/abs/2601.18743)
*Takeshi Kakizaki*
...
### [66] [Efficient Trotter-Suzuki Schemes for Long-time Quantum Dynamics](https://arxiv.org/abs/2601.18756)
...
### [67] [Practical block encodings of matrix polynomials that can also be trivially controlled](https://arxiv.org/abs/2601.18767)
...
### [68] [Hamiltonian Decoded Quantum Interferometry for General Pauli Hamiltonians](https://arxiv.org/abs/2601.18773)
