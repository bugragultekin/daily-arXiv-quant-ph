...
### [1] [Influence of the Electron's Anomalous Magnetic Dipole Moment on High-Atomic-Number Atoms](https://arxiv.org/abs/2606.15995)
...
### [2] [Quantum Machine Learning for Industrial Applications](https://arxiv.org/abs/2606.14822)
*Léo Monbroussou*
...
### [3] [The Distribution Postulate in Algorithmic Bohmian Mechanics](https://arxiv.org/abs/2606.16165)
...
### [4] [Measuring Non-Stabilizerness in an SU(2) Lattice Gauge Theory](https://arxiv.org/abs/2606.14842)
...
### [5] [High-fidelity two-qubit gates in a 7-qubit register for quantum networks](https://arxiv.org/abs/2606.14847)
...
### [6] [Magic transfer in quantum spin chains](https://arxiv.org/abs/2606.14855)
...
### [7] [Finite-Element Matrix Product States for Continuum Models in One Dimension](https://arxiv.org/abs/2606.14873)
...
### [8] [Generalized Kerr-Cat Qubit Codes](https://arxiv.org/abs/2606.14901)
...
### [9] [Optimising Entanglement Distillation Policies](https://arxiv.org/abs/2606.14908)
...
### [10] [Initiation of Superradiance from Different Collective Spin States](https://arxiv.org/abs/2606.14949)
...
### [13] [VQE as Initial State Preparation for QPE on Heisenberg Spin-Glass Hamiltonians](https://arxiv.org/abs/2606.15061)
...
### [14] [Discontinuous strong-to-weak symmetry breaking transition from thermal pure states](https://arxiv.org/abs/2606.15062)
...
### [15] [Quantum simulation of the Liouville equation in classical mechanics with discontinuous potential via Schrödingerization](https://arxiv.org/abs/2606.15066)
*Shi Jin,Shuyi Zhang*
...
### [16] [Quantum learning with a single-atom sensor](https://arxiv.org/abs/2606.15071)
...
### [17] [REGRID-QAOA: A Resource-Efficient Graph-Reduced Hybrid QAOA Framework for Physics-Constrained Power System Islanding](https://arxiv.org/abs/2606.15083)
...
### [18] [Optimizing Wigner Negativity in Scattering Processes Using Energetic Cost Functions](https://arxiv.org/abs/2606.15101)
...
### [19] [Temporal modulation as a resource: enhanced frequency estimation in continuous variable systems](https://arxiv.org/abs/2606.15108)
...
### [20] [Optimal Toffoli-Depth Multi-Controlled Toffoli Decomposition in 2D Qubit Layout](https://arxiv.org/abs/2606.15113)
...
### [21] [Lattice surgery for near-term experimental logical qubit entanglement creation in planar architectures](https://arxiv.org/abs/2606.15190)
...
### [22] [Quantum-classical hybrid models based on error correction for time series forecasting](https://arxiv.org/abs/2606.15213)
...
### [23] [Benchmarking Quantum Extreme Learning based on Gaussian Boson Sampling](https://arxiv.org/abs/2606.15230)
...
### [24] [Light-induced nonadiabatic dissipative quantum dynamics of the Na2 molecule](https://arxiv.org/abs/2606.15292)
...
### [25] [Inverted Dirac oscillator](https://arxiv.org/abs/2606.15303)
*Mustapha Maamache*
...
### [26] [Single-Image Entanglement Verification with Spatially Encoded Measurement Contexts](https://arxiv.org/abs/2606.15382)
...
### [27] [Quantum optimal control of steady orbits](https://arxiv.org/abs/2606.15383)
...
### [28] [Watching a Superconducting Coplanar Waveguide Heat Up with a Single Color Center](https://arxiv.org/abs/2606.15398)
...
### [29] [Scheme for Transport-based Global Entanglement Distribution using Quantum Processors](https://arxiv.org/abs/2606.15421)
...
### [30] [Certified Finite-Shot Operating Windows for Virtual Distillation and Symmetry Verification](https://arxiv.org/abs/2606.15464)
...
### [31] [Hardy and Cabello Arguments in Spatial and Temporal Frauchiger-Renner Scenarios](https://arxiv.org/abs/2606.15467)
...
### [32] [Connecting entanglement growth with local integrals of motion in the disordered Fermi-Hubbard model](https://arxiv.org/abs/2606.15481)
...
### [33] [Quantum Fisher Information and the Speed of Entanglement](https://arxiv.org/abs/2606.15484)
*Zain H. Saleem*
...
### [34] [Orbital-optimized spin-adapted multistate contracted VQE for excited states and properties on quantum hardware](https://arxiv.org/abs/2606.15489)
...
### [35] [Suppressing Intrinsic Spin-Phonon Errors in Trapped-Ion Quantum Simulation](https://arxiv.org/abs/2606.15518)
...
### [36] [Degeneracy Cannot Violate the Quantum Hamming Bound](https://arxiv.org/abs/2606.15558)
...
### [37] [Quantum Illumination with Symmetry-Constrained Random Unitaries](https://arxiv.org/abs/2606.15586)
...
### [38] [A New Definition of Quantum Superposition](https://arxiv.org/abs/2606.15607)
*Stephen Bruce Sontz*
...
### [39] [Synthesizing Arbitrary Non-Hermitian Hamiltonian with Stochastic Floquet Engineering](https://arxiv.org/abs/2606.15664)
...
### [40] [High-performance gates on trapped ion qubits using counterpropagating pulse-shaped laser beams](https://arxiv.org/abs/2606.15672)
...
### [41] [Quantum coherence and Leggett-Garg inequality](https://arxiv.org/abs/2606.15717)
...
### [42] [Comparative Performance Analysis of NIST PQC Standards: From STM32 Software Limitations to FPGA-SoC Acceleration](https://arxiv.org/abs/2606.15744)
...
### [43] [Noise-Adaptive Predictive Dynamical Decoupling](https://arxiv.org/abs/2606.15769)
...
### [44] [MAPS: A Novel Multi-Axial Projective Sphere for Geometrically Visualizing Higher d-Valued Quantum State-Space of Qudits](https://arxiv.org/abs/2606.15801)
*Ali Al-Bayaty*
...
### [45] [Trainable Quantum Channels as Computational Primitives for Quantum Learning](https://arxiv.org/abs/2606.15808)
...
### [46] [Complete Relational Description of Spin in a Quantum Background](https://arxiv.org/abs/2606.15873)
...
### [47] [A Gauge-Covariant Geometric Framework for Non-Hermitian Quantum Systems](https://arxiv.org/abs/2606.15922)
...
### [48] [Experimental Observation of Dynamical Phase Transitions in a Dephased Photonic Quantum Walk](https://arxiv.org/abs/2606.15935)
...
### [49] [Quantum Measurement and Continuous Markov Processes](https://arxiv.org/abs/2606.15958)
*Chris Jackson*
...
### [50] [Learning ground state observables from quantum computing experiments](https://arxiv.org/abs/2606.15983)
...
### [51] [Quantum Algorithm for Open-System Battery Cathodes by Modeling Multiple Strongly Coupled Holstein Polarons with Chain-Mapped Caldeira-Leggett Dynamics](https://arxiv.org/abs/2606.16017)
*Joshua M. Courtney*
...
### [52] [Adiabatically-induced Kawaguchi geometry and jerk in quantum-classical systems](https://arxiv.org/abs/2606.16037)
...
### [53] [Readout-Induced Leakage in Superconducting Circuits with Nonlinear Couplings](https://arxiv.org/abs/2606.16055)
...
### [54] [Enhanced Sensitivity near a Quantum Exceptional Point in the Absence of Engineered Dissipation](https://arxiv.org/abs/2606.16060)
...
### [55] [Enhancing Quantum Machine Learning with Anyons](https://arxiv.org/abs/2606.16090)
...
### [90] [Symmetry Breaking through Superselection by Boundary Conditions](https://arxiv.org/abs/2606.15272)
...
### [91] [Timekeeping Beyond Human Whim: A Critical Analysis of Strong Conventionalism about Clocks](https://arxiv.org/abs/2606.16606)
*Matias Slavov*
...
Abstract: Conventional elements play an integral role in measuring time. Clocks unavoidably require a chosen standard of synchrony. The periodic process selected for the standard is not imposed upon us in any way. Conventionalism, in this regard, offers an insightful perspective on temporal measurement. The strong formulation of this doctrine is, however, questionable. After elaborating on strong conventionalism, it will be argued that it has three downsides: (i) it fails to properly distinguish between highly stable natural processes and complete randomness, as periodicities differ in terms of regularity; (ii) it does not explain that a clock actually measures something, to wit, parts of its own path along its worldline in spacetime; (iii) and relatedly, it omits the distinction between a temporal interval as a physical quantity and the arbitrarily chosen unit of time, leaving the distinction between temporal quantities and units a mystery. This article does not claim that strong conventionalism is incorrect; rather, considering the critical arguments against it, we may conclude that it remains an incomplete theory of what clocks measure.

</details>


### [92] [Information Is Not Physical: Possibility Spaces, Erasure, and the Structure of Unrealized Alternatives](https://arxiv.org/abs/2606.15120)
*Madhurendra Mishra*
