...
### [1] [Making Symmetry Explicit: The Limits of Sophistication](https://arxiv.org/abs/2602.13708)
*Henrique Gomes*
...
### [2] [A Huygens-Leibniz-Lange framework for classical mechanics](https://arxiv.org/abs/2602.14059)
*J. W. van Holten*
...
### [3] [The road of quantum entanglement: from Einstein to 2022 Nobel Prize in Physics](https://arxiv.org/abs/2602.14601)
*Yu Shi*
...
### [4] [Entanglement in quantum spin chains is strictly finite at any temperature](https://arxiv.org/abs/2602.13386)
...
### [5] [No-Go Theorem on Fault Tolerant Gadgets for Multiple Logical Qubits](https://arxiv.org/abs/2602.13395)
...
### [6] [Protection of Exponential Operation using Stabilizer Codes in the Early Fault Tolerance Era](https://arxiv.org/abs/2602.13399)
...
### [7] [On the Redfield and Lindblad master equations](https://arxiv.org/abs/2602.13429)
*Hans C. Fogedby*
...
### [8] [Quantum Algorithm Framework for Phase-Contrast Transmission Electron Microscopy Image Simulation](https://arxiv.org/abs/2602.13438)
...
### [9] [Non-Uniform Quantum Fourier Transform](https://arxiv.org/abs/2602.13472)
...
### [13] [Time-Domain Two-Magnon Interference Enabled by a Tunable Beamsplitter](https://arxiv.org/abs/2602.13572)
...
### [14] [Digitizing ultrafast adiabatic passage with a pulse train](https://arxiv.org/abs/2602.13592)
...
### [15] [Single-reference coupled-cluster theory based on the multi-purpose cluster operator](https://arxiv.org/abs/2602.13605)
...
### [16] [Generation of large Fock states from coherent states using Kerr interaction and displacement](https://arxiv.org/abs/2602.13623)
...
### [17] [Ward-Takahashi Identity and Gauge-Invariant Response Theory for Open Quantum Systems](https://arxiv.org/abs/2602.13632)
...
### [29] [Homodyne Detection of Temporally Resolved Quantum States](https://arxiv.org/abs/2602.13946)
...
### [30] [Wideband Quantum Transduction for Rydberg Atomic Receivers Using Six-Wave Mixing](https://arxiv.org/abs/2602.13955)
...
### [31] [Phase sensitive topological classification of single-qubit measurements in linear cluster states](https://arxiv.org/abs/2602.13990)
...
### [32] [Semiclassical Simulation of Homogeneous Emitter Ensembles with Local Dissipation](https://arxiv.org/abs/2602.14025)
*Lewis Ruks*
...
### [33] [Enhancing collective spin squeezing via one-axis twisting echo control of individual atoms](https://arxiv.org/abs/2602.14036)
...
### [34] [Non-Hermitian Quantum Mechanics of Open Quantum Systems: Revisiting The One-Body Problem](https://arxiv.org/abs/2602.14105)
...
### [35] [Early-stage memory effect on the dephasing charger-mediated quantum battery](https://arxiv.org/abs/2602.14146)
*Yu Wang,Jiasen Jin*
...
### [36] [Approximating the $S$ matrix for solving the Marchenko equation: the case of channels with different thresholds](https://arxiv.org/abs/2602.14150)
*N. A. Khokhlov*
...
### [37] [Bidirectional Quantum Processor Interfacing by a 4-Kelvin Analog Signal Chain for Superconducting Qubit Control and Quantum State Readout](https://arxiv.org/abs/2602.14165)
...
### [38] [TensorCircuit-NG: A Universal, Composable, and Scalable Platform for Quantum Computing and Quantum Simulation](https://arxiv.org/abs/2602.14167)
...
### [39] [Quantum field theory measurements for relativistic particles](https://arxiv.org/abs/2602.14175)
...
### [40] [Fully integrated quantum frequency processor on a silicon chip](https://arxiv.org/abs/2602.14240)
...
### [41] [Geometric phase of arbitrary Mueller evolutions and its two-level quantum analogue](https://arxiv.org/abs/2602.14245)
*José J Gil*
...
### [42] [RASCqL: Reaction-time-limited Architecture for Space-time-efficient Complex qLDPC Logic](https://arxiv.org/abs/2602.14273)
...
### [43] [Quantum entanglement enhanced via dark mode control in molecular optomechanics](https://arxiv.org/abs/2602.14312)
...
### [44] [Scalable Clifford-Based Classical Initialization for the Quantum Approximate Optimization Algorithm](https://arxiv.org/abs/2602.14327)
...
### [45] [High-fidelity Quantum Readout Processing via an Embedded SNAIL Amplifier](https://arxiv.org/abs/2602.14333)
...
### [46] [Fine-Grained Complexity for Quantum Problems from Size-Preserving Circuit-to-Hamiltonian Constructions](https://arxiv.org/abs/2602.14379)
...
### [47] [Anonymous quantum sensing robust against state preparation errors](https://arxiv.org/abs/2602.14396)
...
### [48] [The Multiparameter Frontier: Metrological Hierarchy and Robustness in Dispersive Quantum Interferometry](https://arxiv.org/abs/2602.14420)
...
### [49] [Electron readout contrast enhancement in the parallel nuclear regime of an exchange-coupled donor spin qubit system](https://arxiv.org/abs/2602.14426)
...
### [50] [Fermionic Stoner-Dicke phase transition in Circuit Quantum Magnetostatics](https://arxiv.org/abs/2602.14437)
...
### [51] [A hardware-native time-frequency GKP logical qubit toward fault-tolerant photonic operation](https://arxiv.org/abs/2602.14461)
*Tai Hyun Yoon*
...
### [52] [A lesson from a small particle about quantum theory with strong implications for cosmology](https://arxiv.org/abs/2602.14465)
...
### [53] [Homological origin of transversal implementability of logical diagonal gates in quantum CSS codes](https://arxiv.org/abs/2602.14499)
*Junichi Haruna*
...
### [54] [Bell-like States in Classical Optics: A Process-Theoretic and Sheaf-Theoretic (Categorical) Clarification](https://arxiv.org/abs/2602.14508)
*Partha Ghose*
...
### [55] [Forked Physics Informed Neural Networks for Coupled Systems of Differential equations](https://arxiv.org/abs/2602.14554)
...
### [56] [Effective Caldirola-Kanai Model for Accelerating Twisted Dirac States in Nonuniform Axial Fields](https://arxiv.org/abs/2602.14555)
...
### [57] [Sparse identification of quantum Hamiltonian dynamics via quantum circuit learning](https://arxiv.org/abs/2602.14556)
...
### [58] [Dissipative Spectroscopy](https://arxiv.org/abs/2602.14557)
*Xudong He,Yu Chen*
...
### [63] [Boundary conditions for the Schrödinger equation in the numerical simulation of quantum systems](https://arxiv.org/abs/2602.14654)
*Marco Patriarca*
...
### [64] [Geometric Visualizations of Quantum Mixed States and Density Matrices](https://arxiv.org/abs/2602.14661)
...
### [65] [Kernel-based optimization of measurement operators for quantum reservoir computers](https://arxiv.org/abs/2602.14677)
...
### [66] [NISQ-compatible quantum cryptography based on Parrondo dynamics in discrete-time quantum walks](https://arxiv.org/abs/2602.14678)
...
### [67] [Enhanced multiparameter quantum estimation in cavity magnomechanics via a coherent feedback loop](https://arxiv.org/abs/2602.14688)
...
### [68] [Demonstrating and Benchmarking Classical Shadows for Lindblad Tomography](https://arxiv.org/abs/2602.14694)
...
### [69] [Erratic Liouvillian Skin Localization and Subdiffusive Transport](https://arxiv.org/abs/2602.14698)
*Stefano Longhi*
...
### [70] [Faster Optimal Decoder for Graph Codes with a Single Logical Qubit](https://arxiv.org/abs/2602.14730)
...
### [71] [Projections with Respect to Bures Distance and Fidelity: Closed-Forms and Applications](https://arxiv.org/abs/2602.14732)
...
### [72] [The Signal Horizon: Local Blindness and the Contraction of Pauli-Weight Spectra in Noisy Quantum Encodings](https://arxiv.org/abs/2602.14735)
*Ait Haddou Marwan*
...
### [73] [Coupled integrated photonic quantum memristors using a single photon source made of a colour center](https://arxiv.org/abs/2602.14736)
...
### [74] [Probabilistic Cutoffs in Homogeneous Quantum Repeater Chains](https://arxiv.org/abs/2602.14738)
...
### [75] [Finer sub-Planck structures and displacement sensitivity of SU(1,1) circular states](https://arxiv.org/abs/2602.14752)
...
### [76] [Multi-level spectral navigation with geometric diabatic-adiabatic control](https://arxiv.org/abs/2602.14756)
...
### [77] [Localization Tensor Revisited: Geometric-Probabilistic Foundations and a Structure-Factor Criterion under Periodic Boundaries](https://arxiv.org/abs/2602.14779)
...
### [78] [Constrained Portfolio Optimization via Quantum Approximate Optimization Algorithm (QAOA) with XY-Mixers and Trotterized Initialization: A Hybrid Approach for Direct Indexing](https://arxiv.org/abs/2602.14827)
...
### [79] [Gravitational Decoherence Estimation in Optomechanical Systems](https://arxiv.org/abs/2602.14841)
...
### [80] [Infinite reduction in absorbing time in quantum walks over classical ones](https://arxiv.org/abs/2602.14880)
...
### [81] [Scaling QAOA: transferring optimal adiabatic schedules from small-scale to large-scale variational circuits](https://arxiv.org/abs/2602.14986)
...
### [82] [Rotational Quantum Friction via Spontaneous Decay](https://arxiv.org/abs/2602.14992)
...
### [83] [Instruction-Set Architecture for Programmable NV-Center Quantum Repeater Nodes](https://arxiv.org/abs/2602.14995)
...
### [84] [Low Depth Unitary Coupled Cluster Algorithm for Large Chemical Systems](https://arxiv.org/abs/2602.14999)
